...
//	Update Categeory
	@PutMapping("/update")
	public ResponseEntity<Categeory> updateCategeory(@RequestParam("id") int id, @RequestBody Categeory categeory){
		Categeory cat=this.categeoryService.updateCategeory(id, categeory);
		return new ResponseEntity<Categeory>(cat, HttpStatus.ACCEPTED);
	}
